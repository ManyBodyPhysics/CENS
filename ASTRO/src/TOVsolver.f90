...
!            f90 -c -free TOVsolver.f and link with f90 -o prog.exe TOVsolver.o
!
!
...
!            Language : Fortran 90                              
!            Last Fortran 90 update : 28/dec/1996
!
...
!            The units used internally in the program are:
...
!            m=m/m_solar
!            The dimensionless constants used are
!            
...
!  Read denisty and energy density. Note that the commented line is needed if
!  you have not prepared the energy per particle with the correct units.
         READ (5,*)n(i) , e(i)
